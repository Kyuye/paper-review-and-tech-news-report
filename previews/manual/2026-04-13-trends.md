# Trends Candidate Pack (2026-04-13)

- Candidate pack path: `previews/manual/2026-04-13-trends.md`
- Purpose: paste this into ChatGPT web to draft GitBook posts manually.

## Korean prompt
```text
역할: 너는 합성생물학 전문 에디터다.
목표: 아래 후보 링크를 바탕으로 2026-04-13 동향 글을 한국어로 작성해라.
형식:
- 도입 2~3문장
- 분야별 섹션
- 각 섹션당 핵심 포인트 1~2개
...
Goal: write an English trends post for 2026-04-13 using the candidate links below.
Format:
- 2-3 sentence intro
